...
// Returns the private 'App\Repository\ResgistrationStageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ResgistrationStageRepository.php';

return $this->privates['App\\Repository\\ResgistrationStageRepository'] = new \App\Repository\ResgistrationStageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
