...
// Returns the private 'App\Repository\PreRegistrationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PreRegistrationRepository.php';

return $this->privates['App\\Repository\\PreRegistrationRepository'] = new \App\Repository\PreRegistrationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
